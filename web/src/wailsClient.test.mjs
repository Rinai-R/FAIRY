...
function semanticEmbeddingStatus(overrides = {}) {
  return {
    ...
    modelDataPath: "/tmp/fairy/intelligence/embeddings/bge-small-zh-v1.5/model_quantized.onnx_data",
    tokenizerPath: "/tmp/fairy/intelligence/embeddings/bge-small-zh-v1.5/tokenizer.json",
    modelStatus: "missing",
    modelDataStatus: "",
    tokenizerStatus: "",
