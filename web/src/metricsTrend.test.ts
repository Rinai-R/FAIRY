...
describe("metrics trend projection", () => {
  it("projects one strict metrics snapshot into comparable numeric series", () => {
    ...
    expect(point).toMatchObject({
      ...
      learningEnqueued: 7,
      learningSucceeded: 5,
      learningModelCalls: 4,
      learningInputTokens: 900,
      learningCachedObservedInputTokens: 800,
      learningCachedInputTokens: 600,
      learningCacheWriteTokens: 70,
      learningOutputTokens: 60,
...
function snapshot(): MetricsSnapshot {
  ...
  return {
    ...
    runtime: {
      ...
      experience: {
        learning: {
          enqueued: 7, dropped: 1, succeeded: 5, failed: 1,
