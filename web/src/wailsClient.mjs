...
export function parseSemanticEmbeddingStatus(value) {
  ...
  return Object.freeze({
    ...
    modelDataPath: requireString(value.modelDataPath, "modelDataPath"),
    tokenizerPath: requireString(value.tokenizerPath, "tokenizerPath"),
    modelStatus: requireString(value.modelStatus, "modelStatus"),
    modelDataStatus: requireOptionalString(value.modelDataStatus, "modelDataStatus"),
    tokenizerStatus: requireOptionalString(value.tokenizerStatus, "tokenizerStatus"),
