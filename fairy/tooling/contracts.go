...
func ToolSpecs(webSearchEnabled bool) []model.ToolSpec {
	return ToolSpecsForInteraction(webSearchEnabled, domain.Resolved{Memory: domain.MemoryPersonal})
}

func ToolSpecsForInteraction(webSearchEnabled bool, resolved domain.Resolved) []model.ToolSpec {
...
func InstructionsForTools(toolsEnabled bool) string {
	if toolsEnabled {
...
func InstructionsForInteraction(toolsEnabled bool, resolved domain.Resolved) string {
	if !resolved.AllowsPersonalMemory() {
	...
	return InstructionsForTools(toolsEnabled)
}

// ParseQuery validates the strict JSON query object accepted by model tools.
func ParseQuery(arguments string) (string, error) {
