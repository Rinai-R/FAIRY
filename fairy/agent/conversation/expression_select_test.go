...
func TestSelectSocialExpressionsForToolKeepsOnlyExpressions(t *testing.T) {
	memoryPort := &socialLearningMemory{retrieved: social.SocialMemoryContext{Entries: []social.SocialMemoryEntry{
		...
		{ID: "e2", Kind: social.SocialMemoryExpression, Situation: "安慰焦虑", Content: "先短句接住", RecallCue: "焦虑"},
		{ID: "e3", Kind: social.SocialMemoryExpression, Situation: "吐槽", Content: "轻轻接梗", RecallCue: "吐槽"},
	}}}
...
func TestSelectSocialContextForToolKeepsEpisodeAndBehavior(t *testing.T) {
	memoryPort := &socialLearningMemory{retrieved: social.SocialMemoryContext{Entries: []social.SocialMemoryEntry{
		{ID: "e1", Kind: social.SocialMemoryEpisode, Situation: "话题", Content: "进展", RecallCue: "话题"},
		{ID: "e2", Kind: social.SocialMemoryExpression, Situation: "安慰焦虑", Content: "先短句接住", RecallCue: "焦虑"},
		{ID: "e3", Kind: social.SocialMemoryBehavior, Situation: "被点名", Content: "先短回", RecallCue: "点名"},
	}}}
	service := newSocialLearningTestService(memoryPort, &socialLearningModel{})
