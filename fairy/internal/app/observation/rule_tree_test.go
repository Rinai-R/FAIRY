...
func TestTriggerEnvelopeValidatesEndpointPayloadPair(t *testing.T) {
	now := time.Now()
	private := Resolved{Endpoint: EndpointDesktop, Facts: Facts{Audience: AudienceSingle, Initiation: InitiationDirect, Presentation: PresentationEmbodied}, Principal: PrincipalOwner, Memory: MemoryPersonal}
