...
type (
	DesktopObservation        = obs.DesktopObservation
	DesktopObservationTrigger = obs.DesktopObservationTrigger
	DesktopPrivacyState       = obs.DesktopPrivacyState
	DesktopLifecycleEvent     = obs.DesktopLifecycleEvent
	DesktopActivityCategory   = obs.DesktopActivityCategory
)

const (
	DesktopActivityUnknown   = obs.DesktopActivityUnknown
	DesktopActivityWorking   = obs.DesktopActivityWorking
	DesktopActivityReading   = obs.DesktopActivityReading
	DesktopActivityCommuning = obs.DesktopActivityCommuning
	DesktopActivityIdle      = obs.DesktopActivityIdle

	DesktopLifecycleNone       = obs.DesktopLifecycleNone
	DesktopLifecycleReturned   = obs.DesktopLifecycleReturned
	DesktopLifecycleLeft       = obs.DesktopLifecycleLeft
	DesktopLifecyclePrivacyOn  = obs.DesktopLifecyclePrivacyOn
	DesktopLifecyclePrivacyOff = obs.DesktopLifecyclePrivacyOff

	DesktopPrivacyNormal       = obs.DesktopPrivacyNormal
	DesktopPrivacyLocked       = obs.DesktopPrivacyLocked
	DesktopPrivacyMeeting      = obs.DesktopPrivacyMeeting
	DesktopPrivacyDoNotDisturb = obs.DesktopPrivacyDoNotDisturb
	DesktopPrivacyProtected    = obs.DesktopPrivacyProtected

	DesktopTriggerPeriodic  = obs.DesktopTriggerPeriodic
	DesktopTriggerLifecycle = obs.DesktopTriggerLifecycle
)
...
func CompileDesktopGraph(rulebook DesktopRulebook, sample DesktopObservation) (DesktopGraphPlan, error) {
	if rulebook.Resolved.Endpoint != EndpointDesktop || rulebook.Resolved.Facts.Audience != AudienceSingle || !rulebook.Resolved.AllowsPersonalMemory() {
