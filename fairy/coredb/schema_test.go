...
func TestSchemaModelsDeclareMovedIndexes(t *testing.T) {
	...
	want := []string{
		...
		"knowledge_chunks_version_ordinal_key",
		"knowledge_document_versions_hash_key",
		...
		"social_person_notes_scope_sender",
		"social_person_notes_scope_sender_key",
		"social_reply_feedback_scope_created",
