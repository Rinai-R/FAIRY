...
func TestCompileDesktopGraphUsesCurrentTimeWhenRulebookNowIsUnset(t *testing.T) {
	...
	plan, err := CompileDesktopGraph(DesktopRulebook{
		Resolved:             interaction.Resolved{Endpoint: interaction.EndpointDesktop, Facts: interaction.Facts{Audience: interaction.AudienceSingle}, Memory: interaction.MemoryPersonal},
...
func TestCompileDesktopGraphSuppressesPrivateNodesForPublicOrPrivacy(t *testing.T) {
	...
	rulebook.Resolved.Memory = interaction.MemoryPublic
