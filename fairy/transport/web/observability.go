...
func metricHistoryPoint(response metricsResponse, startedAt time.Time, activeJobs int64) observability.MetricHistoryPoint {
	point := observability.MetricHistoryPoint{
		...
		LearningModelCalls:                uint64(response.Runtime.Experience.Learning.ModelCalls),
		LearningInputTokens:               uint64(response.Runtime.Experience.Learning.InputTokens),
		LearningCachedObservedInputTokens: uint64(response.Runtime.Experience.Learning.CachedObservedInputTokens),
		LearningCachedInputTokens:         uint64(response.Runtime.Experience.Learning.CachedInputTokens),
		LearningCacheWriteTokens:          uint64(response.Runtime.Experience.Learning.CacheWriteTokens),
		LearningOutputTokens:              uint64(response.Runtime.Experience.Learning.OutputTokens),
		FeedbackRegistered:                uint64(response.Runtime.Experience.Feedback.Registered),
		FeedbackSuperseded:                uint64(response.Runtime.Experience.Feedback.Superseded),
		...
		FeedbackModelCalls:                uint64(response.Runtime.Experience.Feedback.ModelCalls),
		FeedbackInputTokens:               uint64(response.Runtime.Experience.Feedback.InputTokens),
		FeedbackCachedObservedInputTokens: uint64(response.Runtime.Experience.Feedback.CachedObservedInputTokens),
		FeedbackCachedInputTokens:         uint64(response.Runtime.Experience.Feedback.CachedInputTokens),
		FeedbackCacheWriteTokens:          uint64(response.Runtime.Experience.Feedback.CacheWriteTokens),
		FeedbackOutputTokens:              uint64(response.Runtime.Experience.Feedback.OutputTokens),
		CompactionL1Applied:               response.Runtime.AgentLoop.Compaction.L1Applied,
		CompactionL2Applied:               response.Runtime.AgentLoop.Compaction.L2Applied,
		CompactionL3Applied:               response.Runtime.AgentLoop.Compaction.L3Applied,
		CompactionFailed:                  response.Runtime.AgentLoop.Compaction.Failed,
