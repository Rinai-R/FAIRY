...
func (s *Server) handleKnowledge(ctx context.Context, c *app.RequestContext) {
	catalog, err := s.rt.KnowledgeStore.CatalogContext(ctx)
	if err != nil {
...
func (s *Server) handleTombstoneKnowledge(ctx context.Context, c *app.RequestContext) {
	if err := s.rt.KnowledgeStore.TombstoneContext(ctx, c.Param("id")); err != nil {
...
func (s *Server) handleIntelligence(ctx context.Context, c *app.RequestContext) {
	...
	c.JSON(http.StatusOK, map[string]any{
		"summary": intelligenceSummary{
			Summary: summary, CandidateKnowledge: knowledgeStats.Candidates, VerifiedKnowledge: knowledgeStats.Verified,
		},
		"activeBackgroundJobs": s.rt.Turns.ActiveBackgroundJobs(),
		"webSearch":            web,
