...
func validateLane(lane PromptLane) error {
	switch lane {
	case PromptLaneRespond, PromptLaneParticipate, PromptLaneCompact, PromptLaneExtract, PromptLaneTranslate, PromptLaneSocialLearn, PromptLaneSocialFeedback, PromptLaneKnowledgeReconcile:
		return nil
	default:
