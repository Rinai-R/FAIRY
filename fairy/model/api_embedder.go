...
// APIEmbedder implements memory.SemanticEmbedder through an OpenAI-compatible
...
func (e *APIEmbedder) Status() memory.SemanticStatus {
	if e.Ready() {
		return memory.SemanticStatusReady
	}
	return memory.SemanticStatusUnavailable
}
