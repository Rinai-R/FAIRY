...
func BuildParticipationInputWithSignals(record character.Record, resolved session.Resolved, reason ParticipationEvaluationReason, messages []AmbientObservation, cacheMessages []AmbientObservation, presence RecentPresence, nowUnixMS int64, transcript []memory.MessageRecord) ([]model.PromptItem, error) {
...
func BuildParticipationInputWithActivity(record character.Record, resolved session.Resolved, reason ParticipationEvaluationReason, messages []AmbientObservation, cacheMessages []AmbientObservation, presence RecentPresence, nowUnixMS int64, activity memory.ConversationActivity) ([]model.PromptItem, error) {
	return buildParticipationInput(record, resolved, reason, messages, cacheMessages, presence, func() (ParticipationSignals, error) {
