...
// RouteTrigger is Initiative's validation and entry-selection boundary. It
// selects a registered Initiative pipeline but never executes business nodes.
...
func NewInitiativeRuleTree() (RuleTree, error) {
	return NewRuleTree(
