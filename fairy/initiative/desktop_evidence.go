...
func (r *EvidenceRegistry) Accept(observation session.DesktopObservation, now time.Time) error {
	if r == nil {
	...
	r.items[observation.ObservationID] = evidence{ID: observation.ObservationID, AcceptedAt: now}
	return nil
}
