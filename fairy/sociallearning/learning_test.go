...
func learningObservations() []participation.AmbientObservation {
	return []participation.AmbientObservation{
...
func (h *learningTestHost) ResolveInteraction(string) (domain.Resolved, error) {
