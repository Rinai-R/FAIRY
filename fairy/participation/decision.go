...
func BuildParticipationInput(record character.Record, resolved domain.Resolved, reason ParticipationEvaluationReason, messages []AmbientObservation, presence RecentPresence) ([]model.PromptItem, error) {
