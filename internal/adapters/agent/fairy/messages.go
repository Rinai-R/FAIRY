...
你必须只输出一个 JSON object，不能输出 Markdown、解释、前后缀文本。`),
		},
		{
			...
			Content: strings.TrimSpace(strings.Join([]string{
				...
				"3. act_count 由材料复杂度决定，长材料不能压成 1-2 幕；每幕只承载一个中等颗粒度主题。",
				...
				"7. 输出 JSON 结构：{\"material_summary\":\"...\",\"expanded_notes\":[\"...\"],\"act_count\":4,\"acts\":[{\"index\":1,\"id\":\"opening\",\"kind\":\"opening\",\"title\":\"...\",\"theme\":\"...\",\"teaching_goal\":\"...\",\"must_cover\":[\"...\"],\"dramatic_role\":\"...\",\"choice_goal\":\"...\",\"decision\":\"continue\"}]}。",
