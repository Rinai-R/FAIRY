...
pub enum ErrorCode {
    ...
    InvalidModelConfig,
    SearchConfigRequired,
    InvalidSearchConfig,
    SearchSecretUnavailable,
    SearchAuthFailed,
    SearchRateLimited,
    SearchFailed,
...
impl ErrorCode {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::SearchConfigRequired => "SEARCH_CONFIG_REQUIRED",
            Self::InvalidSearchConfig => "INVALID_SEARCH_CONFIG",
            Self::SearchSecretUnavailable => "SEARCH_SECRET_UNAVAILABLE",
            Self::SearchAuthFailed => "SEARCH_AUTH_FAILED",
