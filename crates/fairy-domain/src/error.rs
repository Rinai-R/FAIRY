...
pub enum ErrorCode {
    ...
    IntelligenceExtractionFailed,
    InvalidIntelligenceRecord,
    InvalidConversationRecord,
    ExtractionBatchFailed,
    InvalidCharacterBrief,
    CharacterCompileFailed,
    CharacterNotAvailable,
    InvalidVisualManifest,
    VisualPackNotFound,
    CharacterAppearanceUnassigned,
    CharacterAppearanceUnavailable,
    InvalidUserProfile,
...
impl ErrorCode {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::IntelligenceUnavailable => "INTELLIGENCE_UNAVAILABLE",
            Self::IntelligenceExtractionFailed => "INTELLIGENCE_EXTRACTION_FAILED",
            Self::InvalidIntelligenceRecord => "INVALID_INTELLIGENCE_RECORD",
            Self::InvalidConversationRecord => "INVALID_CONVERSATION_RECORD",
            Self::ExtractionBatchFailed => "EXTRACTION_BATCH_FAILED",
            ...
            Self::InvalidVisualManifest => "INVALID_VISUAL_MANIFEST",
            Self::VisualPackNotFound => "VISUAL_PACK_NOT_FOUND",
            Self::CharacterAppearanceUnassigned => "CHARACTER_APPEARANCE_UNASSIGNED",
            Self::CharacterAppearanceUnavailable => "CHARACTER_APPEARANCE_UNAVAILABLE",
    ...
    pub fn from_wire_name(value: &str) -> Option<Self> {
        [
            Self::ModelConfigRequired,
            Self::ModelSecretUnavailable,
            Self::ModelAuthFailed,
            Self::ModelProtocolMismatch,
            Self::ModelStreamFailed,
            Self::ModelResponseInvalid,
            Self::InvalidModelConfig,
            Self::IntelligenceUnavailable,
            Self::IntelligenceExtractionFailed,
            Self::InvalidIntelligenceRecord,
            Self::InvalidConversationRecord,
            Self::ExtractionBatchFailed,
            Self::InvalidCharacterBrief,
            Self::CharacterCompileFailed,
            Self::CharacterNotAvailable,
            Self::InvalidVisualManifest,
            Self::VisualPackNotFound,
            Self::CharacterAppearanceUnassigned,
            Self::CharacterAppearanceUnavailable,
            Self::InvalidUserProfile,
            Self::UserProfileUnavailable,
            Self::TurnInProgress,
            Self::TurnNotActive,
            ...
            Self::StorageIo,
            Self::PromptHistoryInvalid,
            Self::CompactionFailed,
            Self::IpcChannelClosed,
        ]
        .into_iter()
